...
A row goes two ways. The row itself — and the trace id it leads with, which
is there so a trace can be recognised and quoted, not just clicked — opens
that one trace's waterfall: *what happened this time*. The root span
